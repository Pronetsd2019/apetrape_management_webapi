...
require_once __DIR__ . '/../util/error_logger.php';
 ...
 if (!checkUserPermission($userId, 'categories', 'create')) {
     http_response_code(403);
     echo json_encode(['success' => false, 'message' => 'You do not have permission to create category.']);
     exit;
 }
...
try {
    ...
    logException('category_create', $e);
