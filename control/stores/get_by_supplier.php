...
require_once __DIR__ . '/../util/error_logger.php';
 ...
 if (!checkUserPermission($userId, 'stores', 'read')) {
     http_response_code(403);
     echo json_encode(['success' => false, 'message' => 'You do not have permission to read stores.']);
     exit;
 }
...
try {
    ...
    logException('stores_get_by_supplier', $e);
