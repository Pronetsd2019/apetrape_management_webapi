...
try {
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Rejected supplier applications retrieved successfully.',
        'data' => $applications,
        'count' => count($applications)
    ]);

} catch (PDOException $e) {
    logException('supplier_applications_get_rejected', $e);
    http_response_code(500);
    echo json_encode([
        'success' => false,
        'message' => 'Error retrieving rejected applications: ' . $e->getMessage()
    ]);
}
?>
