 ...
 * 
 * Tracks order actions (created, updated, cancelled, payment_recorded, etc.) in the order_track table
 ...
 * @param string $action The action performed (e.g., 'created', 'updated', 'cancelled', 'payment_recorded')
