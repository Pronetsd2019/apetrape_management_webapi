...
try {
    ...
    logException('mobile_auth_signout', $e);
    
    http_response_code(500);
    echo json_encode([
        'success' => false,
        'error' => 'Server error',
        'message' => 'An error occurred during signout. Please try again later.',
        'error_details' => 'Error during signout: ' . $e->getMessage()
    ]);
} catch (Exception $e) {
    logException('mobile_auth_signout', $e);
