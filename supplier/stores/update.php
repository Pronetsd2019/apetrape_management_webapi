...
try {
    ...
    $stmt = $pdo->prepare("SELECT id, supplier_id, contact_person_id FROM stores WHERE id = ? AND supplier_id = ?");
    ...
    $current_supplier_id = $supplierId; // Store already validated to belong to this supplier
    ...
    // Note: supplier_id cannot be changed as stores can only be updated by their owning supplier
    ...
    logException('supplier_stores_update', $e);
